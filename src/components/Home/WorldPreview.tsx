  ...
  <section className="px-4 py-20 sm:px-6 lg:px-8">
    <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[.8fr_1.2fr]">
      <div>
        ...
        <Link  href="/map" className="nexus-button-primary mt-7">Open interactive map <ArrowRight size={18} /></Link>
      </div>
      <motion.div initial={{ opacity: 0, scale: .94 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative min-h-[430px] overflow-hidden rounded-[var(--r-2xl)] border border-white/10 bg-gradient-to-br from-cyan-500/[.08] via-slate-950 to-purple-600/[.08] shadow-2xl">
        ...
        <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between rounded-2xl border border-white/10 bg-slate-950/75 p-4">
          <div><p className="nexus-eyebrow">Live map preview</p><p className="mt-1 text-sm text-slate-300">Explore 195+ countries</p></div>
