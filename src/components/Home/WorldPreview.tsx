  ...
  <section className="bg-[#020617] px-4 py-20 sm:px-6 lg:px-8">
    <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[.8fr_1.2fr]">
      <div>
        ...
        <Link  href="/map" className="mt-7 inline-flex items-center gap-2 rounded-2xl bg-cyan-500 px-6 py-3.5 font-semibold text-slate-950">Open interactive map <ArrowRight size={18} /></Link>
      </div>
